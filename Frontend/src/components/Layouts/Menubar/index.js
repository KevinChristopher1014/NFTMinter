  ...
  return (
    <div >
      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          <Grid sx={{ width: '50%' }}>
            <IconButton onClick={() => {history('/')}}>
              <img src="nft.webp" style={{width:50, height:50, cursor : "pointer"}}/>
            </IconButton>
          </Grid>
        ...
        <List >
          <ListItem button onClick={() => {history('/mint')}} selected={CurrentPage=='Mint'}>
            <ListItemIcon>
              <AddPhotoAlternateIcon sx={{color:'white'}}/>
            </ListItemIcon>
            <ListItemText primary="Mint" />
          </ListItem>
          <ListItem button onClick={() => {history('/nfts')}} selected={CurrentPage=='NFTs'}>
            <ListItemIcon>
